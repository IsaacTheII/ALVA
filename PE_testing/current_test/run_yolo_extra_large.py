...
def main(src):
    ...
    # configure the extra large model called yolov8x-pose.pt
    ...
    try:
        os.remove(os.path.join(os.path.dirname(__file__), "assets/yolo_extra_large_output"))
    ...
    output_dir = "assets/yolo_extra_large_output"
